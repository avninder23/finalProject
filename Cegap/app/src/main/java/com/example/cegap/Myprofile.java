...
public class Myprofile extends AppCompatActivity {
    ...
    Button btn_backtolist,recievemessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recievemessage=findViewById(R.id.recievermessage);

        recievemessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(getApplicationContext(),RecieveMessage.class);
