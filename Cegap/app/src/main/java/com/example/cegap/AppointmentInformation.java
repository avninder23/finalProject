...
public class AppointmentInformation extends AppCompatActivity {
    ...
    TextView fn,ln,email_id,cn,occ,qual,dob,user_id,timeandate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeandate=findViewById(R.id.textView3);
        new MyTask().execute();
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        String stn_fn, stn_ln, stn_occ, stn_email, stn_qual, stn_cn, stn_dob, stn_status,timeanddate;
        int userId, user_Id,appointment;
        ...
        protected Void doInBackground(Void... params) {
            ...
            appointment=bundle.getInt("APPOINTMENTID");
            URL url = null;

            try {

                url = new URL("http://192.168.2.30:19950/Cegapp/mobile/application/userlist2&" + user_Id+"&"+appointment);
                ...
                timeanddate=obj.getString("APPOINTMENT_TIME");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (getStn_status().equals("OK")) {
                ...
                timeandate.setText("APPOINTMENT TIME IS :"+timeanddate);
